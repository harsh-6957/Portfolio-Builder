...
export function UserNav() {
  // Using the first mock user for demonstration
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent className="w-56" align="end" forceMount>
          ...
          <DropdownMenuGroup>
            ...
            <DropdownMenuItem asChild>
              <Link href="/dashboard/billing" className="cursor-pointer flex w-full">
          ...
          <DropdownMenuSeparator />
          <DropdownMenuItem asChild>
            <Link href="/logout" className="cursor-pointer flex w-full">
